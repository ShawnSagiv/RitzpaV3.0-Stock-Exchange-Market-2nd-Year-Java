...
public class LogoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        StockExchange stockExchange = ServletUtils.getStockExchange(getServletContext());

        if (usernameFromSession != null) {
            System.out.println("Clearing session for " + usernameFromSession);
            userManager.removeUser(usernameFromSession);
            stockExchange.removeUserFromActiveUsersList(stockExchange.getUser(usernameFromSession));
            stockExchange.getUsersMap().remove(usernameFromSession);
